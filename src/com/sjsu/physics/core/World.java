...
//
//	/*
//	 * Determine which physics thread it should be in based on geometry, then
//	 * add body to that thread
//	 */
//	public void addBodyToWorld(RigidBody b)
//	{
//		Vector2 center = b.center();
...
//		{
//			// System.out.println("Object has gone out of bounds, cannot add object");
//			threads.get(b.process()).removeBody(b);
//			b = null;
//			return;
//		}
//
...
//
//		/* if we can't find a process for it, just put it into process1 */
//		System.out.println("Warning, cannot find processor to add body to!");
//		threads.get(0).insertBody(b);
//		b.setProcess(0);
//		b.setId(bodyCount++);
//		return;
...
//	public static ArrayList<RigidBody> allBodies()
//	{
//		ArrayList<RigidBody> allBodies = new ArrayList<RigidBody>(Globals.DEFAULT_BODY_SIZE
//				* Globals.NUM_PROCESSORS);
//
//		for (int i = 0; i < threads.size(); i++)
//		{
//			// Add all thread bodies
...
//
/////*
////* Return the bodies that belong solely to the world node.. that is bodies
////* that are overlapping two or more processors
////*/
////public ArrayList<RigidBody> overlappingBodies()
////{
////	return worldRootNode.bodies();
...
////{
////	/* Clear all objects from all the physics children's quadtrees */
////	/* TODO only clear objects that have moved and reinsert those only */
////	worldRootNode.clearObjects();
////
////	for (int i = 0; i < threads.size(); i++)
////		threads.get(i).run();
