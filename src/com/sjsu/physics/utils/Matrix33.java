...
public class Matrix33 implements Serializable 
{
	...
	public static final Vector3 mul(Matrix33 A, Vector3 v) {
		return new Vector3(v.x * A.ex.x + v.y * A.ey.x + v.z + A.ez.x, v.x * A.ex.y + v.y * A.ey.y + v.z
    ...
    {
        return new Vector2(vector.x * ex.x() + vector.y * ex.y(), 
        		vector.x * ey.x() + vector.y * ey.y());
    }
}
