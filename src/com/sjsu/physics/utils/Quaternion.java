...
public class Quaternion
{
	...
	{
		Quaternion a = this;
		return new Quaternion(a.data[0] + b.data[0], a.data[1] + b.data[1], a.data[2] + b.data[2],
				a.data[3] + b.data[3]);
	}
	...
	{
		Quaternion a = this;
		float y0 = a.data[0] * b.data[0] - a.data[1] * b.data[1] - a.data[2] * b.data[2]
				- a.data[3] * b.data[3];
		float y1 = a.data[0] * b.data[1] + a.data[1] * b.data[0] + a.data[2] * b.data[3]
				- a.data[3] * b.data[2];
		float y2 = a.data[0] * b.data[2] - a.data[1] * b.data[3] + a.data[2] * b.data[0]
				+ a.data[3] * b.data[1];
		float y3 = a.data[0] * b.data[3] + a.data[1] * b.data[2] - a.data[2] * b.data[1]
				+ a.data[3] * b.data[0];
	...
	{
		Quaternion q = new Quaternion(0, vector.x * scale, vector.y * scale, vector.y * scale);
		q = q.times(this);
