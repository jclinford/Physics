...
public abstract class RigidBody
{
	...
	private Vector2 netForce; // The sum of the forces that are being applied to
								// this object - zero'd every iteration
	private float angularVelocity; // Angular velocity (w) in radians per second
	private float angularAcceleration; // angular accell (dw/dt) in radians per
										// second^2
	private float netTorque; // The sum of the torques that are being applied to
								// this object

	protected Vector2 inverseMomentOfInertia;
	private float inverseMass; // inverse mass is easier to determine fixed
								// objects, infinite mass, etc
	...
	/*
	 * Update function for this rigid body Essentially updates the pos &
	 * velocity each frame for time t
	 */
